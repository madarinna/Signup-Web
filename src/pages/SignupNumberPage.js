	...
	return (
		<Container component="main" maxWidth="sm">
			...
			<div className={classes.paper}>
				{/* this is the component used for input the phone number */}
				<MobileNumberField />
				<Formik
					...
					validate={(values) => {
						// change to 8 digits since it is thai number
					...
					{({
						...
						<form>
							<Typography
								...
								align="justify"
							>
								Add your country code after the + sign to your mobile number. By
								selecting continue you agree to the Terms and Services.
							</Typography>
